const App = {
    ...
    config: {
        AWS_videoURL_Base: "https://agsdentistry03.s3.us-east-1.amazonaws.com/assets/videos/interaction/",
...
async playVideoNow(videoUrl) {
    ...
    async sendMessage() {
        ...
        try {
            const response = await fetch(this.config.ENDPOINT_URL + "agsvh/case3/chat_exact", {
                method: "POST",
